...
<html lang="es">
  <head>
    ...
    <title>Back In Black(Oficial)</title>
  <style>
    .btn-violeta{
        color:#FFFFFF; 
  ...
  <body class="fondo">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark align-items-center fixed-top" style ="background-color:black"; >
		...
		<div class="container mt-5 bg-white">
			<br>
			<h1 class="text-center">Back in black</h1>
				<div class="row">
					<div class="col-7 text-muted">
						...
						Forget the hearse 'cause I never die<br>
						I got nine lives<br>
						Cat's eyes<br>
						Abusin' every one of them and running wild</p>
						...
						Yes, I'm back in black</p>
						
						<p>Back in the back<br>
						Of a Cadillac<br>
						...
						Don't try to push your luck, just get out of my way</p>
